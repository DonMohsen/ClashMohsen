...
const ClashRoyalBrawlStarsSinglePlayerPage =async ({ params }: Props) => {
  ...
  return (
    <>
      <PlayerStats tag={playerTag} game={GameType.brawlstars} />
    </>
  )
}

export default ClashRoyalBrawlStarsSinglePlayerPage