  ...
  return (
    <div className=" max-w-3xl overflow-x-hidden mx-auto bg-white shadow-xl h-full w-full rounded-b-2xl  p-3 flex">
      <div className="w-[120px] transition-all duration-500 ">
        ...
        <motion.div
          className={cn(
            "bg-[#7b7d69] rounded-l-[10px] p-2 flex items-center justify-center pointer w-[110px] h-[110px] ",
            selectedStats === "top" &&
      ...
      <div className="flex flex-col w-full bg-gradient-to-l from-[#676554] to-[#7b7d69] rounded-r-[10px] max-sm:rounded-b-[10px] p-2 max-sm:min-h-[350px]">
        {/* //!right side stats */}
        ...
        {selectedStats === "top" ? (
          <div className="w-full flex h-full max-sm:flex-col ">
            ...
            <div className="w-[50%] max-sm:text-[8px] max-sm:w-full h-full font-ClashBold text-[10px] mt-1 flex flex-col items-center justify-between gap-1 text-white sm:border-r-2 border-black/[0.3] sm:pr-3">
              <p>
              {clan.description}
            ...
            <div className="w-[50%] max-sm:text-[8px] max-sm:w-full font-ClashBold text-[10px] mt-1 flex flex-col items-center justify-start gap-1 text-white sm:pl-3 sm:pr-[40px]">
              ...
              <div className="w-full border-b-2 border-black/[0.1] flex items-center justify-between ">
                ...
                <div className="flex items-center justify-center gap-[2px]">
                  ...
                  <Image alt="builderbase-trophy" src='/builderbase-trophy.png' width={100} height={100} className="w-4 h-4"/>
                </div>
