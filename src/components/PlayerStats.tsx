    ...
    <div className="bg-white shadow-md rounded-lg p-6 max-w-md mx-auto space-y-4">
      ...
      {cocData && (
        <div className="space-y-2">
          <p><strong>Town Hall:</strong> {cocData.townHallLevel}</p>
          <p><strong>Trophies:</strong> {cocData.trophies}</p>
          <p><strong>War Stars:</strong> {cocData.warStars}</p>
          <p><strong>Attacks Won:</strong> {cocData.attackWins}</p>
          <p><strong>Defenses Won:</strong> {cocData.defenseWins}</p>
        </div>
      )}
